...
export function drawSkybox() {
  const front = new THREE.TextureLoader().load("/textures/front2.bmp");
  const back = new THREE.TextureLoader().load("/textures/back2.bmp");
  const left = new THREE.TextureLoader().load("/textures/left2.bmp");
  const right = new THREE.TextureLoader().load("/textures/right2.bmp");
  const top = new THREE.TextureLoader().load("/textures/top2.bmp");
  const bottom = new THREE.TextureLoader().load("/textures/bottom2.bmp");
